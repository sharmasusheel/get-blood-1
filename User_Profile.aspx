...
<%@ page title="" language="C#" theme="SkinFile" masterpagefile="~/MasterPage3.master" autoeventwireup="true" inherits="User_Profile, App_Web_z0lqy2q0" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder6" Runat="Server">
    <div>
      <table style="border-style: solid; border-radius:25px; background-color:yellowgreen; border-width: 2px">
        <tr>
          <center>  <td class="auto-style6">&nbsp;</td>  <td colspan="2" class="auto-style6"><h4 style="color:white; font-size: 23px; text-decoration: underline overline blink; text-transform: uppercase; font-family: georgia, 'Times New Roman', Times, serif;">Set up your profile</h4>
       ...
       <tr>
        ...
        <tr>
            ...
            <td class="auto-style10" align="center">
                ...
                <asp:TextBox ID="TextBox12" placeholder="dd/mm/yyyy"  runat="server"></asp:TextBox>

                
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ForeColor="Red" ControlToValidate="TextBox12" ValidationExpression="(((0|1)[1-9]|2[1-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$"
    ErrorMessage="Invalid date format." ValidationGroup="Group1" />
        ...
        <tr>
            ...
            <td class="auto-style20" align="center">
                <asp:TextBox ID="TextBox8" runat="server" Width="117px" Height="18px"></asp:TextBox>
            </td>
        </tr>  
