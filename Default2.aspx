<%@ page language="C#" autoeventwireup="true" masterpagefile="~/MasterPage6.master" theme="SkinFile" inherits="Default2, App_Web_z0lqy2q0" %>
    ...
    <div id ="d1" style="margin-top:-0px"  >
        <table id="tbl1" style="height: 400px; width: 400px; background-color:greenyellow;border-radius: 50px;">
            ...
            <tr>
                ...
                <td align="center">
                    &nbsp;<asp:TextBox ID="TextBox3" placeholder="enter login_id"   runat="server" Width="170px" Height="25px" OnTextChanged="TextBox3_TextChanged" AutoCompleteType="Disabled"  ></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td align="center">
                    <asp:TextBox ID="TextBox4" placeholder="enter password" runat="server" Width="170px" Height="25px" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style2" colspan="2">
                    <br />
                    <center style="height: 37px"><asp:ImageButton ID="ImageButton1" ImageUrl="~/download.jpg" Height="46px" runat="server" Width="137px" OnClick="ImageButton1_Click" /></center>
                </td>
            </tr>
            <tr>
                <td class="auto-style2" colspan="2">
